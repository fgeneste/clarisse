...
/**
 * REST controller for managing {@link fr.senat.clarisse.domain.Structure}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Structure> partialUpdateStructure(
        ...
        Optional<Structure> result = structureRepository
            ...
            .map(existingStructure -> {
                ...
                if (structure.getDateDeCreation() != null) {
                    existingStructure.setDateDeCreation(structure.getDateDeCreation());
                }
                if (structure.getDateDeCloture() != null) {
                    existingStructure.setDateDeCloture(structure.getDateDeCloture());
                }
                if (structure.getCodeAmeli() != null) {
                    existingStructure.setCodeAmeli(structure.getCodeAmeli());
                }
                if (structure.getCodeSirpas() != null) {
                    existingStructure.setCodeSirpas(structure.getCodeSirpas());
                }
                if (structure.getCodeReprographie() != null) {
                    existingStructure.setCodeReprographie(structure.getCodeReprographie());
                }
                if (structure.getArticle() != null) {
                    existingStructure.setArticle(structure.getArticle());
                }
                if (structure.getLibelle() != null) {
                    existingStructure.setLibelle(structure.getLibelle());
                }
                if (structure.getLibelleCourt() != null) {
                    existingStructure.setLibelleCourt(structure.getLibelleCourt());
                }
                if (structure.getLibelleLong() != null) {
                    existingStructure.setLibelleLong(structure.getLibelleLong());
                }
                if (structure.getOrdre() != null) {
                    existingStructure.setOrdre(structure.getOrdre());
                }
                if (structure.getPublicationSurInternet() != null) {
                    existingStructure.setPublicationSurInternet(structure.getPublicationSurInternet());
                }
