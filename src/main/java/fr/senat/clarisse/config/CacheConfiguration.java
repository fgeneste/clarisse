package fr.senat.clarisse.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.senat.clarisse.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.senat.clarisse.repository.UserRepository.USERS_BY_EMAIL_CACHE);
