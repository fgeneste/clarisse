      ...
      <table class="table table-striped" aria-describedby="personnes">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('clarisseApp.personne.nuancePolitique')">Nuance Politique</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="personne in personnes" :key="personne.id" data-cy="entityTable">
            ...
            <td>
              <div v-if="personne.nuancePolitique">
                <router-link :to="{ name: 'NuancePolitiqueView', params: { nuancePolitiqueId: personne.nuancePolitique.id } }">{{
                  personne.nuancePolitique.id
                }}</router-link>
              </div>
            </td>
            <td class="text-right">
