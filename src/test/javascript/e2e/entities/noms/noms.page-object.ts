...
export default class NomsComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('noms-heading'));
...
export class NomsDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('clarisseApp.noms.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-noms'));
}
