...
export default class NuancePolitiqueComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('nuance-politique-heading'));
...
export class NuancePolitiqueDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('clarisseApp.nuancePolitique.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-nuancePolitique'));
}
