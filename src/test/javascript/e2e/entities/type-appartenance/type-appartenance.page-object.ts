...
export default class TypeAppartenanceComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('type-appartenance-heading'));
...
export class TypeAppartenanceDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('clarisseApp.typeAppartenance.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-typeAppartenance'));
}
