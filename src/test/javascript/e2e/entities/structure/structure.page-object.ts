...
export default class StructureComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('structure-heading'));
...
export class StructureDeleteDialog {
  ...
  title: ElementFinder = element(by.id('clarisseApp.structure.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-structure'));
}
