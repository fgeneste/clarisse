...
export default class PersonneComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('personne-heading'));
...
export class PersonneDeleteDialog {
  ...
  title: ElementFinder = element(by.id('clarisseApp.personne.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-personne'));
}
